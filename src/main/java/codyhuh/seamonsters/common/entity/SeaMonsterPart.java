...
public class SeaMonsterPart extends PartEntity<SeaMonster> {
    public final SeaMonster parentMob;
    public final String name;
    public final EntityDimensions size;

    public SeaMonsterPart(SeaMonster entity, String name, float x, float y) {
        super(entity);
